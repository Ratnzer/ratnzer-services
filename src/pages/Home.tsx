  ...
  return (
    <div className="pb-24 pt-4 space-y-6 will-change-scroll">
      ...
      <div className="sticky top-0 z-40 px-4">
        <div className="flex items-center gap-3 overflow-x-auto no-scrollbar pb-2 pr-1 touch-pan-x touch-pan-y pointer-events-auto" style={{ touchAction: 'pan-x pan-y' }}>
