...
const Home: React.FC<Props> = ({
  ...
  return (
    <div className="pb-24 pt-0 space-y-4 will-change-scroll">
        ...
        <div className="px-4">
          <div className="bg-[#242636] border border-yellow-400/30 rounded-xl p-3 flex items-center gap-3 overflow-hidden shadow-sm">
            ...
            <div
              ...
              className={`marquee-container flex-1 overflow-hidden relative h-[40px] flex items-center ${shouldScroll ? 'is-scrolling' : ''}`}
            >
              <div
