...
const TopHeader: React.FC<Props> = ({ 
  ...
  return (
    <div className="fixed top-0 left-0 right-0 flex justify-center bg-[#13141f]/95 backdrop-blur-md border-b border-gray-800/50 z-50 h-[50px] shadow-sm">
...
<h1 className="text-lg font-bold text-yellow-400 drop-shadow-sm tracking-wide">
		              خدمات راتنزر
		            </h1>
	         </div>
