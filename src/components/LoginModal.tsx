...
{/* Welcome Text */}
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-4">
                        ...
                        <button 
                            ...
                            disabled={isLoading}
                            className={`bg-[#593B8B] hover:bg-[#4a3174] text-white font-bold py-3 rounded-xl shadow-md active:scale-95 transition-all flex items-center justify-center gap-2 text-xs ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                        >
