		                 ...
		                 >
		                    <div className="flex items-center gap-4 relative z-10">
		                        ...
		                        <div className="text-right">
		                                <h3 className={`font-bold text-base ${selectedMethod === 'wallet' ? 'text-yellow-400' : 'text-white'}`}>محفظتي</h3>
		                 ...
		                 {!isPiUser && (
		                     ...
		                     >
		                        <div className="flex items-center gap-4 relative z-10">
		                            ...
		                            <div className="text-right">
		                                <h3 className={`font-bold text-base ${selectedMethod === 'card' ? 'text-yellow-400' : 'text-white'}`}>بطاقة مصرفية</h3>
                 ...
                 {/* Pi Network Option */}
	                 ...
	                 >
	                    <div className="flex items-center gap-4 relative z-10">
	                        ...
	                        <div className="text-right">
		                            <h3 className={`font-bold text-base ${selectedMethod === 'pi' ? 'text-yellow-400' : 'text-white'}`}>الدفع عبر Pi</h3>
